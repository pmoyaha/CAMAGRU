...
if (isset($_POST['submit'])) {
    ...
    if (strcmp($newpass, $repeatP) == 0) {
        if (strlen($newpass) > 5) {
            ...
            $_SESSION['error'] = "Password must atleast 8-16 characters, containing 3 out of 4 of the following: Lowercase charecters, uppercase characters, digits (0-9) and one or more of the following symbols: @ # $ & + = []";
    }
    else
